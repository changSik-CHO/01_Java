...
public class CastingPractice2 {
	...
	public static void main(String[] args) {
		...
		// 1 정수형 변수 age 에 자신의 나이를 저장하고, System.out.println() 을 이용해 "나는 25살입니다." 형식으로 출력하시오.
		 	int age = 25; 
		 	System.out.println("나는" + age + "살입니다 ");
		 	
		 	// 2 int score = 90; 으로 시작하여 점수를 10점 더 올린 뒤, "최종 점수: 100" 이 출력되도록 프로그램을 작성하시오.
		 	int score = 90; // 초기 점수 저장
		 	score = score + 10; // 점수 10점 더하기 score += 10;
		 	System.out.println("최종점수: "+ score );
		 	
		 	// 3 자동형 변환
		 	// 정수형 변수 a를 선언하고 값 10을 저장한뒤, double 타입 변수 b에 a를 대입하여 출력 하시오
		 		int a = 10;
		 		double b = a; // 자동 형변환
		 	...
		 	// 실수형 변수 pi 에 3.14159 를 저장한 뒤, 이를 int 로 변환하여 출력하시오.
		 	 double pi = 3.14159; // 실수형 변수 pi 선언 및 저장
		 	 int num = (int) pi;  // 강제 형변환: 소수점 이하 버림
		 	 System.out.printf("pi = %.2f, num = %d\n", pi, num); // 개행처리를 안해줌...printf
		 	...
		 	int intHeight = (int) height; // double → int 강제 형변환
