...
// crtl + shift + o : 현재 클래스에서 import 되지 않은 클래스를
// 자동으로 import 되지 않은 클래스를 자동으로 import
// 그리고 사용되지 않는 클래스도 자동으로 import 삭제

// import : 다른 패키지에 존재하는 클래스를 얻어오는 구문
// import java.util.Scanner : java.util.Scanner : java.util 패키지에서
